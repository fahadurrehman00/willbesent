                    ...
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="flex gap-4">
                            ...
                            <div class="bg-white p-4 rounded-lg shadow w-64">
                                ...
                                <p
                                    class="font-semibold {{ isset($user->transactions->first()->notarization) && $user->transactions->first()->notarization == '1' ? 'text-green-500' : 'text-red-500' }}">
                                    {{ isset($user->transactions->first()->notarization) && $user->transactions->first()->notarization == '1' ? 'Active' : 'Inactive' }}
                                </p>
